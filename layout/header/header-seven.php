                ...
                <div class="rts-header__wrapper">
                    ...
                    <div class="rts-header__logo">
                        <a href="index.php" class="site-logo">
                            <img class="logo-white" width="100px" src="assets/images/logo/logo.png" alt="Hostie">
                            <img class="logo-dark" width="100px" src="assets/images/logo/logo.png" alt="Hostie">
                        </a>
                    </div>
                    <!-- FOR NAVIGATION MENU -->
                    ...
                    <nav class="rts-header__menu" id="mobile-menu">
                        <div class="hostie-menu">
                            <ul class="list-unstyled hostie-desktop-menu">
                                ...
                                <li class="menu-item">
                                    <a href="#" class="hostie-dropdown-main-element">Portfolio</a>
                                </li>
                                <li class="menu-item">
                                    <a href="services.php" class="hostie-dropdown-main-element">Services</a>
                                </li>
                                <li class="menu-item">
                                    <a href="about.php" class="hostie-dropdown-main-element">About</a>
                                </li>
