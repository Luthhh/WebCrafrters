            ...
            <div class="row align-items-end position-relative">
                <div class="col-lg-6">
                    <div class="rts-hero__content w-550">
                        ...
                        <h1 class="heading"  data-sal="slide-down" data-sal-delay="300" data-sal-duration="800">Build Your Business Website Today
                        </h1>
                ...
                <div class="col-lg-12">
                    <div class="rts-brand__wrapper">
                        <div class="rts-brand__wrapper--text">
                            <h5 data-sal="slide-down" data-sal-delay="300" data-sal-duration="800">Website solutions trusted by over <span>3,000</span> businesses worldwide.</h5>
        ...
        <div class="row">
            <div class="col-12">
                <div class="rts-hosting-type__section">
                    <h3 class="title" data-sal="slide-down" data-sal-delay="300" data-sal-duration="800">Website Development Packages</h3>
                    <p data-sal="slide-down" data-sal-delay="400" data-sal-duration="800">Choose the right plan to create a website that fits your business needs.</p>
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            <div class="rts-hosting-type__single">
                                ...
                                <p class="excerpt">A professional online presence to introduce your business and services.</p>
                                <h6 class="price__start">Starting from $499</h6>
                                <a href="company-profile.php" class="primary__btn border__btn">See Plan <i class="fa-regular fa-long-arrow-right"></i></a>
                            </div>
                        </div>
                        ...
                        <div class="swiper-slide">
                            <div class="rts-hosting-type__single">
                                ...
                                <p class="excerpt">Online solutions for managing sales, inventory, and business operations.</p>
                                <h6 class="price__start">Starting from $899</h6>
                                <a href="pos-website.php" class="primary__btn border__btn">See Plan <i class="fa-regular fa-long-arrow-right"></i></a>
                            </div>
                        </div>
                        <!-- POS package end -->
                        <!-- Marketplace package -->
                        <div class="swiper-slide">
                            <div class="rts-hosting-type__single">
                                ...
                                <p class="excerpt">Create a multi-vendor platform to buy and sell products online.</p>
                                <h6 class="price__start">Starting from $1,199</h6>
                                <a href="marketplace-website.php" class="primary__btn border__btn">See Plan <i class="fa-regular fa-long-arrow-right"></i></a>
                            </div>
                        </div>
                        ...
                        <div class="swiper-slide">
                            <div class="rts-hosting-type__single">
                                ...
                                <p class="excerpt">Tailor-made websites to suit your specific needs and requirements.</p>
                                <h6 class="price__start">Starting from $1,799</h6>
                                <a href="custom-website.php" class="primary__btn border__btn">See Plan <i class="fa-regular fa-long-arrow-right"></i></a>
                            </div>
                        </div>
                        <!-- Custom package end -->
                    </div>
            ...
            <div class="rts-flash-sell__bg mt--100">
                <div class="row align-items-center">
                    ...
                    <div class="rts-flash-sell__title">
                        <h3 data-sal="slide-down" data-sal-delay="300" data-sal-duration="800">Web Design Flash Sale</h3>
                        <p data-sal="slide-down" data-sal-delay="400" data-sal-duration="800">For a limited time, get your website designed at unbeatable prices!</p>
                ...
                <div class="rts-whychoose__content">
                    ...
                    <div class="single" data-sal="slide-right" data-sal-delay="300" data-sal-duration="800">
                        ...
                        <div class="single__content">
                            ...
                            <p>Get your website up and running quickly, so you can start growing your business without delays!</p>
                        </div>
                    </div>
                    <!-- single content-->
                    <div class="single" data-sal="slide-right" data-sal-delay="400" data-sal-duration="800">
                        ...
                        <div class="single__content">
                            ...
                            <p>Our team of experts is always here to help you with any questions or issues, anytime you need assistance.</p>
                        </div>
                    </div>
                    <!-- single content-->
                    <div class="single" data-sal="slide-right" data-sal-delay="500" data-sal-duration="800">
                        ...
                        <div class="single__content">
                            ...
                            <p>We tailor each website to meet the unique needs of your business, ensuring it aligns perfectly with your goals.</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row justify-content-center">
            <div class="rts-section text-center w-560">
                ...
                <p class="rts-section__description" data-sal="slide-down" data-sal-delay="400" data-sal-duration="800">
                    Whether you're starting a blog, building an online store, or showcasing your business, we have the perfect plan for you.
                </p>
            </div>
        </div>
        <!-- PLAN -->
                            ...
                            <tr>
                                ...
                                <th class="package__item">
                                    <div class="package__item__info">
                                        ...
                                        <span class="start">Starting at $299*</span>
                                        <form action="#">
                                            <select name="select" id="select" class="price__select">
                                                <option value="1">$299</option>
                                                <option value="2">$499</option>
                                            </select>
                                            <button type="submit" aria-label="buy package" class="primary__btn primary__bg buy__now">Buy Now</button>
                                        </form>
                                    </div>
                                </th>
                                <!-- top-right-corner -->
                                <th class="package__item">
                                    <div class="package__item__info">
                                        ...
                                        <span class="start">Starting at $499*</span>
                                        <form action="#">
            ...
            <div class="rts-cta__wrapper">
                <div class="rts-cta__left">
                    ...
                    <p data-sal="slide-down" data-sal-delay="400" data-sal-duration="800">
                        Our reliable hosting solutions are designed to give your website the speed, security, and support it deserves. Get started with the best hosting experience today!
                    </p>
